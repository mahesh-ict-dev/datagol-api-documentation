...
|---------|-------------|----------|---------|
| Backend API | Testing | `https://testing-be.datagol.ai` | Agent CRUD, conversations, permissions |
| Backend API | Production | `https://be.datagol.ai` | Agent CRUD, conversations, permissions |
| AI Core | Testing | `https://testing-core-ai.datagol.ai` | Chat completion, streaming |
